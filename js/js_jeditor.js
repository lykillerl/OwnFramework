(function($) {
  ...
  function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
    ...
    // URL
      ...
      $popup.html('Enter URL:<br><input type="text" class="txt" value="http://" size="35"><br><input type="button" class="btn" value="Submit">');
      popupTypeClass = PROMPT_CLASS;
    }

    // Paste as Text
    else if (popupName == "pastetext") {
      $popup.html('Paste your content here and click submit.<br /><textarea cols="40" rows="3" class="txt"></textarea><br /><input type="button" class="btn" value="Submit">');
      popupTypeClass = PROMPT_CLASS;
    }
